...
- [x] Smooth Movement 
  ...
  * Does not throw players back back.
- [x] MCPE 1.2 Support 
...
- [x] No Bad Packets! 
  ...
  * Only LoginPacket, Resource and Behavior packs packets, and 1-2 required packets. 
...
- [x] DarkBot
  * Virtual Intelligent Bot;
    ...
    * move
    * etc.
  * say "hi darkbot" in-game to test :)
- Other feautures:
 * [ ] Piston (indev)
 * [x] Banner (1.2 only)
 * [x] Parrots (1.2 only)
