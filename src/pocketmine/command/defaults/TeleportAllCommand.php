...
class TeleportAllCommand extends VanillaCommand{
	
	public function __construct($name){
		parent::__construct(
			$name,
			"%pocketmine.command.teleportall.description",
			"%commands.teleportall.usage"
		);
		$this->setPermission("pocketmine.command.teleportall");
	}
